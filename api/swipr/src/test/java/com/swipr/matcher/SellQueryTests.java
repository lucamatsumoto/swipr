...
public class SellQueryTests {
    ...
    SellQuery sellQueryTwo = new SellQuery(2, 0, 10, 500, Query.BPLATE|Query.COVEL);
    ...
    public void equals_SameSellQuery () {
        //Tests if calling SellQuery.equals on a SellQuery object with the same values for all fields returns true
        Assert.assertTrue(sellQueryOne.equals(sellQueryZero));
    }

    @Test
    public void equals_DifferentObjects () {
        //Tests if calling SellQuery.equals on another non SellQuery object returns false
        Assert.assertFalse(sellQueryOne.equals(intOne));
    }

    @Test
    public void equals_DifferentUserId () {
        //Tests if calling SellQuery.equals on another SellQuery object with a different userId returns false
